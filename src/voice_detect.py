#import wave
#
#handle = wave.open('39846769.wav', 'r')
...
#
#
#myaudio = intro = AudioSegment.from_wav("1536580159.wav")
#
#silence = silence.detect_silence(myaudio, min_silence_len=3000, silence_thresh=-16)
#
